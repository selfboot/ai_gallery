      ...
      <div className="flex flex-col items-center bg-gray-100 p-4">
        <div className="text-lg mb-4 font-bold">
          ...
          {chess.gameStatus === "checkmate" &&
            t("checkmate_announcement", { winner: translatePlayer(chess.currentPlayer === "red" ? "black" : "red") })}
                  ...
                  return (
                    <div
                      ...
                      className={`w-16 h-16 border border-black flex justify-center items-center
                                             ...
                                             ${
                                               chess.selectedPiece &&
                                               chess.selectedPiece.row === (rowIndex < 5 ? rowIndex : rowIndex - 1) &&
        ...
        <div className="flex space-x-4">
          ...
          <button className="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600" onClick={restartGame}>
            {t("restart_game")}
          </button>
        </div>
