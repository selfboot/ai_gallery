...
export async function generateMetadata(props) {
  ...
  return createToolMetadata("imagepdf", lang);
}
...
export default async function ImagePdfPage(props) {
  ...
  return (
    <div className="container mx-auto mt-4">
      ...
      <ScopedI18nProvider locale={lang} scope="tools/imagepdf"><ImagePdfContent /></ScopedI18nProvider>
      <BlogMarkdown lang={lang} directory="src/app/[lang]/tools/imagepdf" />
      <ToolStructuredData toolId="imagepdf" lang={lang} />
