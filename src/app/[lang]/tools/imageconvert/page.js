...
export async function generateMetadata(props) {
  ...
  return createToolMetadata("imageconvert", lang);
}
...
export default async function ImageConvertPage(props) {
  ...
  return (
    <div className="container mx-auto mt-4">
      ...
      <ScopedI18nProvider locale={lang} scope="tools/imageconvert"><ImageConvertContent /></ScopedI18nProvider>
      <BlogMarkdown lang={lang} directory="src/app/[lang]/tools/imageconvert" />
      <ToolStructuredData toolId="imageconvert" lang={lang} />
