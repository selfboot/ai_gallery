...
export async function generateMetadata(props) {
  ...
  return createToolMetadata("imagecrop", lang);
}
...
export default async function ImageCropPage(props) {
  ...
  return (
    <div className="container mx-auto mt-4">
      ...
      <ScopedI18nProvider locale={lang} scope="tools/imagecrop"><ImageCropContent /></ScopedI18nProvider>
      <BlogMarkdown lang={lang} directory="src/app/[lang]/tools/imagecrop" />
      <ToolStructuredData toolId="imagecrop" lang={lang} />
