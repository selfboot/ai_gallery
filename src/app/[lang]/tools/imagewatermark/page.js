...
export async function generateMetadata(props) {
  ...
  return createToolMetadata("imagewatermark", lang);
}
...
export default async function ImageWatermarkPage(props) {
  ...
  return (
    <div className="container mx-auto mt-4">
      ...
      <ScopedI18nProvider locale={lang} scope="tools/imagewatermark"><ImageWatermarkContent /></ScopedI18nProvider>
      <BlogMarkdown lang={lang} directory="src/app/[lang]/tools/imagewatermark" />
      <ToolStructuredData toolId="imagewatermark" lang={lang} />
