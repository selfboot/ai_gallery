import { checkLiveFour, checkRushFour } from '../move';
...
describe('Gomoku checkRushFour - Valid Rush Four', () => {
  const testCases = [
    {
  ...
  testCases.forEach(testCase => {
    test(testCase.name, () => {
      const { position: [row, col], board: updatedBoard } = findXPositionAndReplace(testCase.board, testCase.player);
      const result = checkRushFour(updatedBoard, row, col, testCase.player);
      expect(result).toEqual(expect.arrayContaining(testCase.expected));
      expect(result.length).toBe(testCase.expected.length);
...
describe('Gomoku checkRushFour - Not Rush Four', () => {
  const testCases = [
    {
      name: "Not Rush Four (Live Four)",
      board: [
        ["", "", "", "", "", "", "", "", "", "", "", "", "", "", ""],
        ["", "", "", "", "", "", "", "", "", "", "", "", "", "", ""],
        ["", "", "", "", "", "", "", "", "", "", "", "", "", "", ""],
    ...
    {
      name: "Not Rush Four (Three in a row)",
      board: [
        ["", "", "", "", "", "", "", "", "", "", "", "", "", "", ""],
        ["", "", "", "", "", "", "", "", "", "", "", "", "", "", ""],
        ["", "", "", "", "", "", "", "", "", "", "", "", "", "", ""],
    ...
    {
      name: "Not Rush Four (Blocked on both ends)",
      board: [
        ["", "", "", "", "", "", "", "", "", "", "", "", "", "", ""],
        ["", "", "", "", "", "", "", "", "", "", "", "", "", "", ""],
        ["", "", "", "", "", "", "", "", "", "", "", "", "", "", ""],
