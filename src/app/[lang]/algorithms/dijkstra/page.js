...
import DijkstraVisualization from "./ClientContent";
...
export default async function DijkstraPage(props) {
  ...
  return (
    <>
      ...
      <ScopedI18nProvider locale={lang} scope="algorithms/dijkstra"><DijkstraVisualization lang={lang} /></ScopedI18nProvider>
