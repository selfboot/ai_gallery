...
import JumpHashVisualization from "./ClientContent";
...
export default async function JumpHashPage(props) {
  ...
  return (
    <>
      ...
      <ScopedI18nProvider locale={lang} scope="algorithms/jumphash"><JumpHashVisualization lang={lang} /></ScopedI18nProvider>
