...
import AVLTreeVisualization from "./ClientContent";
...
export default async function AVLTreePage(props) {
  ...
  return (
    <>
      ...
      <ScopedI18nProvider locale={lang} scope="algorithms/avltree"><AVLTreeVisualization lang={lang} /></ScopedI18nProvider>
