...
import BinarySearchTreeVisualization from "./ClientContent";
...
export default async function BinarySearchTreePage(props) {
  ...
  return (
    <>
      ...
      <ScopedI18nProvider locale={lang} scope="algorithms/binarysearchtree"><BinarySearchTreeVisualization lang={lang} /></ScopedI18nProvider>
